            ...
            <React.Fragment>
                <form id="form-search" className="form-inline" onSubmit={this.handleSubmit}>
                    {/* <Link to={`/latiendadelpintor${this.state.busqueda}`} id="submit" type="submit"> */}
                        ...
                        <Link to={`/latiendadelpintor${this.state.busqueda}`} id="submit" role="button" type="submit" className="btn btn-primary" onClick={this.handleClick}><i className="fa fa-search"></i> BUSCAR</Link>
                    {/* </Link> */}
                </form>
            </React.Fragment>
        );
